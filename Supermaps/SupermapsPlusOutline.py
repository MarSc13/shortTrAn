...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 14 23:36:58 2022
...
def Supermap(path_results,fldrnm_maps,path_ecc_lut,path_err_lut,outline_path,highlighting,resultpath,stat_thres,diff,n_sim_sqrs,strict,N):
    ...
    for i in range(1,N+1): 
        ...
        plt.title('Supermap Cell ' + str(i))
        if np.size(outline) == 2:
            plt.plot(outline[0][:,0],outline[0][:,1], color = 'k', linewidth=1.5) 
            #plt.hold
...
if __name__ == "__main__":                       
    ...
    highlighting = 'No'
    resultpath = '/Volumes/Vin/TrackingVSGAtto/Correlation_flegalla/PythonAnalysis/results/Supermaps0199_outline'
    ...
    Supermap(path_results,fldrnm_maps,path_ecc_lut,path_err_lut,outline_path,highlighting,resultpath,stat_thres,diff,n_sim_sqrs,strict,N)   
